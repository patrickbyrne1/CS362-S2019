...
int useAdventurerCard(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos) {
	int currentPlayer = whoseTurn(state);
...
int useCouncilRoomCard(struct gameState *state, int handPos) {
	int i;
	int j;
	int currentPlayer = whoseTurn(state);
...
int useMineCard(int choice1, int choice2, struct gameState *state, int handPos) {
	int i;
	int j;
	int currentPlayer = whoseTurn(state);
...
int useSmithyCard(struct gameState *state, int handPos) {
	int i;
	int currentPlayer = whoseTurn(state);
...
int useVillageCard(struct gameState *state, int handPos) {
	int currentPlayer = whoseTurn(state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		useAdventurerCard(card, choice1, choice2, choice3, state, handPos);
			
    case council_room:
		useCouncilRoomCard(state, handPos);
    ...
    case mine:
		useMineCard(choice1, choice2, state, handPos);
    ...
    case smithy:
		useSmithyCard(state, handPos);
		
    case village:
		useVillageCard(state, handPos);
